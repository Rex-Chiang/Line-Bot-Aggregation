...
CELERY_MAX_MEMORY_PER_CHILD = 20000
...
CHATGPT_PROMPT_EXAMPLE = os.environ.get("CHATGPT_PROMPT_EXAMPLE")
CHATGPT_PROMPT_TRANSLATION = os.environ.get("CHATGPT_PROMPT_TRANSLATION")